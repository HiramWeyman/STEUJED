...
export class IntegrantesUserService {
  ...
  getUsuarios(): Observable<Usuarios[]> {
    const urlEndPoint = `${environment.rutaAPI}` + '/Integrante';
  ...
  getUsuariosPerfil(ids: any): Observable<Usuarios[]> {
    const urlEndPoint = `${environment.rutaAPI}` + '/usuariosPerfilInt' + `/${ids}`;
    return this.http.get(urlEndPoint).pipe(
      map(response => response as Usuarios[])
    );
  }
  ...
  getUsuariosActividad(ids: any): Observable<Usuarios[]> {
    const urlEndPoint = `${environment.rutaAPI}` + '/usuariosActividadInt' + `/${ids}`;
    return this.http.get(urlEndPoint).pipe(
      map(response => response as Usuarios[])
    );
  }
  ...
  getUsuariosNombre(nombre: any): Observable<Usuarios[]> {
    const urlEndPoint = `${environment.rutaAPI}` + '/usuariosNombreInt' + `/${nombre}`;
    return this.http.get(urlEndPoint).pipe(
      map(response => response as Usuarios[])
    );
  }
